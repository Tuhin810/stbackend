...
const JobCard = ({ jobDetails }: JobDetailsProps) => {
    ...
    const routeToJobDetails = () => {
        const path = '/recruiter/jobDetails/' + jobDetails._id;
        navigate(path);
    }
        ...
        <div>
            <div className="card w-full p-4 mb-7 text-left bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700 cursor-pointer" onClick={routeToJobDetails}>
                ...
                <p className="mb-2 inline-flex font-semibold items-center text-base text-gray-800  dark:text-gray-400">
                    ...
                    Company Name | {jobDetails.jobType}
                </p>
                <br />
                ...
                <div className="w-full threeButtons justify-between mt-5">
                    <div className="left-buttons ">
                        <button type="button" className=" noneDisplayAfter420px py-2.5 px-5 mr-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">See Details</button>
                    </div>
