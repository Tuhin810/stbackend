            ...
            {/* <div className="navbar fixed top-0 left-0 w-full py-4 bg-transparent z-50 transition-opacity">
                <div className="max-w-6xl mx-auto flex justify-between items-center px-4">
                    ...
                    <nav className="space-x-10">
                        <a href="#" className="text-blue-600 hover:text-gray-300" onClick={()=>{routeTo('/')}}>Home</a>
                    ...
                    <div className=" flex flex-row justify-between">
                        ...
                        <div className="lg:flex hidden flex-auto justify-end flex-row ">
                            ...
                            <div className="flex flex-row lg:space-x-3 xl:space-x-4">
                                ...
                                <button onClick={()=>{routeTo('/home')}}className="rounded-md flex space-x-2 w-24 h-10 font-normal text-md leading-3 text-gray-800 font-bold focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">
								<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
  <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z"/>
</svg>
                                    <p className="text-base text-">Home</p>
       
                                </button>
								<button className="rounded-md flex space-x-2 w-28 h-10 font-normal text-sm leading-3 text-gray-800  focus:outline-none focus:bg-gray-200 hover:bg-gray-200 duration-150 justify-center items-center">
...
<p className="text-base">Find Jobs</p>
  ...
  <path d="M2 11h1v1H2v-1Zm2 0h1v1H4v-1Zm-2 2h1v1H2v-1Zm2 0h1v1H4v-1Zm4-4h1v1H8V9Zm2 0h1v1h-1V9Zm-2 2h1v1H8v-1Zm2 0h1v1h-1v-1Zm2-2h1v1h-1V9Zm0 2h1v1h-1v-1ZM8 7h1v1H8V7Zm2 0h1v1h-1V7Zm2 0h1v1h-1V7ZM8 5h1v1H8V5Zm2 0h1v1h-1V5Zm2 0h1v1h-1V5Zm0-2h1v1h-1V3Z"/>
                        ...
                        <div className=" hidden sm:flex xl:pl-4 lg:pl-3 justify-end flex-row sm:space-x-4 md:space-x-6 lg:space-x-3 xl:space-x-4">
                            {/* sign up button */}
                            <button onClick={()=>{routeTo('/userType')}} className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-gray-800  focus:outline-none focus:bg-gray-200 bg-gray-200 duration-150 justify-center items-center">
                   ...
                   <path fill-rule="evenodd" d="M13.5 5a.5.5 0 0 1 .5.5V7h1.5a.5.5 0 0 1 0 1H14v1.5a.5.5 0 0 1-1 0V8h-1.5a.5.5 0 0 1 0-1H13V5.5a.5.5 0 0 1 .5-.5z"/>
                       ...
                       <p>Sign Up</p>                      
                            ...
                            {/* login button */}
                            <button onClick={()=>{routeTo('/login/Type')}} className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-white bg-blue-500 justify-center items-center">
      <p>Sign In</p>
  ...
  <div></div>
                    ...
                    <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} transform duration-150 sm:hidden mt-4 bg-white px-10 pb-8`}>
