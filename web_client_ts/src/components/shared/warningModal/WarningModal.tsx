...
const WarningModal = ({ message, Img, leftButtonText, leftMethod, id }: ModalProps) => {
        ...
        <div className="relative px-4 md:px-0 w-full max-w-md max-h-full">
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-6 text-center">
              ...
              <button data-modal-hide="popup-modal" type="button" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 
