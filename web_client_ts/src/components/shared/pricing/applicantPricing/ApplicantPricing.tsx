...
const ApplicantPricing = ({handleLoginButton,handleSignUpButton}:IHeroProps) => {
    return (
        <div className="bg-[#f5f9ff] pb-12 overflow-y-hidden" style={{ minHeight: 600 }}>
            {/* Code block starts */}
            <div className="bg-[#f5f9ff]">
                <div className="container mx-auto flex flex-col justify-center items-center py-12 sm:py-24"  style={{ minHeight: 600 }}>
                    <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col  mb-5 sm:mb-10">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-gray-800 font-black leading-7 md:leading-10">
                           We Are Absolutely Free for
                            <span className="text-indigo-700"> Job Seekers </span>
                        </h1>
...
export default ApplicantPricing;
