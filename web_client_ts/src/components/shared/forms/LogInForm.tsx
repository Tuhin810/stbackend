...
const LogInForm = ({handleChangeEmail,handleChangePassword}:LoginForms) => {
    return (
        <div>
            ...
            <div className="mb-4">
                <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 darkno:text-white">Email</label>
            ...
            <div className="mb-4">
                <label htmlFor="password" className="block mb-2 text-sm font-medium text-gray-900 darkno:text-white">Password</label>
