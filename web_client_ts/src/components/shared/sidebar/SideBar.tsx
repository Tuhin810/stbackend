...
const SideBar = () => {
    ...
    return (
        <div>
            <aside id="logo-sidebar" className="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-800 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
                <div className="h-full px-3 pb-4 overflow-y-auto bg-gray-800 ">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/recruiter/jobs" className="flex items-center p-2 rounded-lg text-white hover:bg-gray-100 hover:text-black dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link to="/recruiter/postjob" className="flex items-center p-2 text-white hover:bg-gray-100 hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link to="/recruiter/pricing" className="flex items-center p-2 text-white hover:bg-gray-100 hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="#" className="flex items-center p-2 text-white hover:bg-gray-100 hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <Link to="/home" className="flex items-center p-2 text-white hover:bg-gray-100 hover:text-black rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group" onClick={logout}>
