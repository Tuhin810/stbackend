      ...
      <div className="flex flex-shrink-0 items-center ml-auto">
        <button className="inline-flex items-center p-2 hover:bg-gray-100 focus:bg-gray-100 rounded-lg">
          ...
          <div className="hidden md:flex md:flex-col md:items-end md:leading-tight">
            ...
            <span className="text-sm text-gray-600">Aeonix</span>
          </div>
        ...
        <div className="border-l pl-3 ml-3 space-x-1">
          ...
          <button onClick={()=>{navigate("/home")}} className="relative p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
