...
const RecruiterMobileNavbar = ({ show, setShow,logout }: IMobileApplicantNavbarProps) => {
                            ...
                            <div className="flex flex-col justify-between h-full w-full">
                                <div>
                                    ...
                                    <ul className="font-extralight">
                                        <Link className="cursor-pointer" to="/applicant/RecommendedJobs/">
                                            <li className=" pt-10">
                                        ...
                                        <Link className="cursor-pointer" to="/applicant/profile">
                                            <li className=" pt-10">
                                                <div className="flex items-center">
...
export default RecruiterMobileNavbar