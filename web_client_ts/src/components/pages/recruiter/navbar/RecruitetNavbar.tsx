...
const RecruiterNavbar = () => {
    const [isRecruiterLoggedIn, setIsRecruiterLoggedIn] = useState<boolean>(false);
    const checkRecruiterLoggedIn = (): void => {
        setIsRecruiterLoggedIn(() => getUserType() == "recruiter");
    }
    useEffect(() => {
        checkRecruiterLoggedIn();
    })
    return (
        <div id='recruiterNavBar'>
            {
                (isRecruiterLoggedIn) ?
                    ...
                    <nav className="navbar fixed bg-white shadow dark:bg-gray-900 w-full z-20 top-0 left-0 border-gray-200 dark:border-gray-600">
