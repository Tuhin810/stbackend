      ...
      <header className="flex fixed top-0 z-50 w-full items-center h-20 px-6 sm:px-10 bg-white drop-shadow-lg">
        ...
        <div className="flex flex-shrink-0 items-center ml-auto">
          ...
          <div className="border-l pl-3 ml-3 space-x-1">
            ...
            <button onClick={logout} className="relative p-2 hidden flex gap-2 md:inline text-gray-400 hover:bg-gray-100 hover:text-gray-600 focus:bg-gray-100 focus:text-gray-600 rounded-full">
