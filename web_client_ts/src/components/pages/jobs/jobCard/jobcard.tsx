...
export default function card({companyName, role, functionalArea,urgency, employmentType,experience}:CardProps){
	return(
		<>
			...
			<div className="relative overflow-hidden transition-all duration-500 ease-in-out bg-white border rounded-md  sm:w-8/12 sm:my-4 my-2 shadow shadow-blue-500/40">
                <div className="p-6">
                        ...
                        <div className="col-span-12 lg:col-span-9 xl:col-span-10">
                            ...
                            <div className="mt-4">
                                <div className="flex flex-wrap gap-1.5">
                                    ...
                                    <span className="bg-yellow-500/20 text-yellow-500 text-11 px-2 py-0.5 font-medium rounded">{urgency}</span>
                    ...
                    <div className="grid grid-cols-12">
                        ...
                        <div className="col-span-12 mt-2 md:col-span-6 lg:col-span-5 lg:mt-0  flex flex-wrap justify-evenly items-center">
                        	<div className="ltr:lg:text-right rtl:lg:text-left ">
                                <a href="#applyNow" data-bs-toggle="modal" className="sm:px-2 sm:py-2.5  text-blue-600 hover:underline underline-offset-[6px] decoration-2 rounded-md text-md rounded-md ">View</a>
                            </div>
                            <div className="ltr:lg:text-right rtl:lg:text-left ">
