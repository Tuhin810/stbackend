      ...
      <section className="w-full mx-auto bg-white pt-16 ">
        <div>
          <div role="contentinfo" className="flex items-center flex-col px-4">
            <h1 tabIndex={0} className="focus:outline-none text-4xl lg:text-4xl font-extrabold text-center leading-10 text-gray-800 lg:w-5/12 md:w-9/12 pt-4 capitalize">A <span className="text-indigo-600">dozen years </span>of excellence <br/>your trust, our legacy
              {/* <Typewriter
                words={[' The Best', ' StarMark']}
                loop={7}
                cursor
                cursorStyle='.'
                typeSpeed={70}
