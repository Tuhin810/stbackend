...
const Stats = () => {
    ...
    return (
        <div className="px-4 py-2 md:py-8 pb-5 md:pb-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
            <div className="grid grid-cols-2 row-gap-8 md:grid-cols-4">
                <div className="text-center md:border-r">
                    <h6 className="text-4xl md:text-5xl font-bold "><CountUp isCounting end={200} duration={1.2} />K</h6>
