...
Properties
 ">
		    Companies We Work With
				...
				<div className='logos flex flex-wrap justify-center md:gap-10 md:mx-12 sm:mx-4'>
					
{/* //company card */}
<div className="   transform translate-y-4 hover:translate-y-0 duration-500 ease-in-out 
 py-3 center mx-auto">
    <div className="bg-white px-4 pt-5 md:pt-0 md:pb-5 md:pt-5 rounded-lg shadow-lg text-center w-24 md:w-48 ">
      <div className="mb-4">
        <img className="w-auto mx-auto rounded-full object-cover object-center"
		 src={mw} alt="Avatar Upload" />
		 <div className="mt-2 h-10 w-3/4 bg-blue-50 p-2 rounded-3xl text-gray-600 font-bold mx-auto">Jio</div>
      </div>
      <label className="cursor-pointer mt-0 md:mt-6">
        <span className="hidden md:inline mt-2 text-base leading-normal px-4  py-2 bg-blue-500 text-white text-sm rounded-full" >view jobs</span>
				...
				{/* //company card */}
<div className="   transform translate-y-4 hover:translate-y-0 duration-500 ease-in-out  py-3 center mx-auto">
    <div className="bg-white px-4 pt-5  md:pb-5 md:pt-5 rounded-lg shadow-lg text-center w-24 md:w-48">
      <div className="mb-4">
        <img className="w-auto mx-auto rounded-full "
		 src={mw} alt="Avatar Upload" />
		 <div className="mt-2 h-10 w-3/4 bg-blue-50 p-2 rounded-3xl text-gray-600 font-bold mx-auto">Jio</div>
      </div>
      <label className="cursor-pointer mt-0 md:mt-6">
