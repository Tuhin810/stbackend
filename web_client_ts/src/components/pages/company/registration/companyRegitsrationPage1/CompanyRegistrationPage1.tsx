    ...
    return (
        <div>
            <div className="mb-4">
                ...
                <input type="text" id="name" name="name" className="mt-1 p-2 border rounded w-full focus:outline-none focus:ring focus:border-blue-300" required onChange={(e) => handleChangeCompanyDetails(e)} />
            </div>
            <div className="mb-4">
