...
const Login = () => {
  ...
  return (
    ...
    <div className="relative h-screen flex ">
      ...
      backgroundImage: `url("https://vod-progressive.akamaized.net/exp=1692720679~acl=%2Fvimeo-prod-skyfire-std-us%2F01%2F3849%2F14%2F369247354%2F1529218058.mp4~hmac=eced1c067bddeeabdd00898be0efe70cbed4349650b9aabe422a3bb044868d95/vimeo-prod-skyfire-std-us/01/3849/14/369247354/1529218058.mp4")` 
    }}>
    ...
    <a href="" target="_blank" title="" className="flex absolute top-5 text-center text-gray-100 focus:outline-none">
      ...
      className="object-cover mx-auto w-32 h-8 rounded-md w-10 h-10"/> </a>
    <img src="https://images.pexels.com/photos/4467687/pexels-photo-4467687.jpeg?auto=compress&cs=tinysrgb&w=600"
     className="h-96 absolute right-5 mr-5 rounded-xl shadow-xl"/>
          ...
          <div className="md:flex md:items-center md:justify-center w-full sm:w-auto md:h-full w-2/5 xl:w-2/5 p-8  md:p-10 lg:p-14 sm:rounded-lg md:rounded-none bg-white ">
            <div className="max-w-md w-full space-y-8">
             ...
             <a className="w-11 h-11 items-center justify-center inline-flex rounded-2xl font-bold text-lg  text-white bg-red-400 hover:shadow-lg cursor-pointer transition ease-in duration-300">
      ...
      <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>
              ...
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-gray-300 font-normal">or continue with Email</span>
                <span className="h-px w-16 bg-gray-200"></span>
              </div>
              <form className="mt-8 space-y-6" action="#" method="POST">
                ...
                <div className="relative">
                  ...
                  <input value={email} className=" w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="" placeholder="mail@gmail.com" />
                </div>
                <div className="mt-8 content-center">
                  <label className="ml-3 text-sm font-bold text-gray-700 tracking-wide">
                    Password
                  </label>
                  <input value={password} className="w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Enter your password" />
                </div>
               
                <div>
                  <button onClick={()=>{login}}  type="submit" className="w-full mb-5 flex justify-center bg-gradient-to-r from-indigo-500 to-blue-600  hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600 text-gray-100 p-4  rounded-full tracking-wide font-semibold  shadow-lg cursor-pointer transition ease-in duration-500">
                    Sign in
                  </button>
                </div>
