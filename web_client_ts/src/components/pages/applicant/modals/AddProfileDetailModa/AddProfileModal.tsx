...
export const AddProfileModal = ({ defaultApplicantDetails }: MyProfileDetailsProps) => {
  ...
  const handleCopyCurrentToPermanent = () => {
    if (checked) {
      setApplicantDetails((prevApplicantDetails) => ({
        ...prevApplicantDetails,
        permanent_address: defaultApplicantDetails.current_address,
      }));
    }
  };
          ...
          <div className="relative bg-white rounded-xl shadow ">
            ...
            <div className="px-6 py-6 lg:px-8">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <label htmlFor="current_assress" className="block  text-sm font-medium text-gray-900 ">
                    Current Address
                  </label>
                  <input
                    onChange={(e) => {
                ...
                <div className="">
                  ...
                  <div className="flex mb-2">
                    <button onClick={() => setChecked(true)}>Copy Current to Permanent</button>
                  </div>
                  ...
                  <div className="">
                    {
                      ...
                      value={checked ? defaultApplicantDetails.current_address : applicantDetails.permanent_address}
                      type="text"
