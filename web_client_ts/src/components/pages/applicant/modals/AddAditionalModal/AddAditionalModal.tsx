...
export const AddAditionalModal = ({ defaultApplicantDetails }: MyProfileDetailsProps) => {
  ...
  return (
    <div>
      <div id="updateAdditionalProfile" className={` fixed ease-out duration-300 inset-0 z-40 flex items-center hidden justify-center bg-black bg-opacity-50 backdrop-blur-sm`}>
        <div className="relative w-full max-w-md max-h-full ease-linear duration-500">
          <div className="relative bg-white rounded-xl shadow ease-in duration-500">
