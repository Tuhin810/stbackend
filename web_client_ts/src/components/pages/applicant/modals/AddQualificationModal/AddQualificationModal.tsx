...
const AddQualificationModal = () => {
    ...
    const [educationDetails,setEducationDetails]=useState<ApplicantEducation>({} as ApplicantEducation);
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="mb-4 flex">
                                    <div className="w-1/2 pr-2">
                                        ...
                                        <input type="number" id="from_year" name="from_year" className="w-full border rounded px-3 py-2 focus:outline-none focus:ring focus:border-blue-300"  />
                                    </div>
