                ...
                <div className=" w-full">
                    <div className="p-4">
                        <div className='flex justify-between'>
                            <div className="heading text-xl text-gray-800 font-semibold mb-4 inline-flex items-center">My <span className="text-blue-700 mx-2">Degrees</span>
                            ...
                            <button type="button" className="text-blue-700 border border-blue-700 font-small rounded-full text-sm h-8 px-2 text-center inline-flex items-center" onClick={() => { showModal('addDegrees') }}>
                        ...
                        <div className="flex flex-wrap space-x-8 justify-around">
                        {
                            qualificationDetails.map((qualification, value) => {
                                return (
                                    <div className="flex flex-col mb-2" key={value}>
                                        <h3 className="text-orange-600 text-lg">{qualification.qualification}</h3>
                                        <p className="text-blue-600">{qualification.inst_name}</p>
                                        <p className="text-black">From <span className="text-blue-600">{qualification.from_year}</span> To <span className="text-blue-600">{qualification.to_year}</span> </p>
                                    </div>
                                )
                            })
                        }
