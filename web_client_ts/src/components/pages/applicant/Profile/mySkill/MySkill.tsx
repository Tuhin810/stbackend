                ...
                <div className=" w-full">
                    <div className="p-4">
                        <div className='flex justify-between pr-10'>
                            <div className="heading text-xl text-gray-500  mb-4 inline-flex items-center font-semibold">My <span className="font-semibold text-blue-500 mx-1">Skills</span>
