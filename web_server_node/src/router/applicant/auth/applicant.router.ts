...
import { deleteApplicantSkillById, updateApplicantSkillById } from "../../../controller/users/applicantSkill/applicantSkill.controller";
...
router.delete("/applicant/deleteApplicantSkills/:id/:skill", deleteApplicantSkillById);
